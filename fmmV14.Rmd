...
$\tilde\Sigma_{2,1} \in \mathbb{R^{{m\times}n}}$ eine Näherung von
$\Sigma_{2,1} \in \mathbb{R^{{m\times}n}}$,
$\tilde\Sigma_{1,1} \in \mathbb{R^{n{\times}n}}$ invertierbar und eine
Näherung von $\Sigma_{1,1} \in \mathbb{R^{n{\times}n}}$$ und
$\tilde{\mathbf{y}} \in \mathbb{R^{n}}$ eine Näherung von
$\mathbf{y} \in \mathbb{R^{n}}$ . Sei außerdem $\lVert{ \cdot }\rVert$
eine zulässige Norm und seien $\kappa_1$, $\kappa_2$ und $\kappa_3$ die
Konditionszahlen von drei Teilproblemen.

Definiere folgende drei Teilprobleme:

$\mu_{2|1}(\tilde\Sigma_{2,1}) = \tilde\Sigma_{2,1}\Sigma_{1,1}^{-1}{y}$
(1)

$\mu_{2|1}(\tilde\Sigma_{1,1}) = \Sigma_{2,1}\tilde\Sigma_{1,1}^{-1}{y}$
(2)

$\mu_{2|1}(\mathbf{\tilde y}) = \Sigma_{2,1}\Sigma_{1,1}^{-1}{\tilde y}$
(3).
...
$\frac{\lVert\mu_{2|1}(\tilde\Sigma_{2,1})-\mu_{2|1}(\Sigma_{2,1})\rVert}{\lVert\mu_{2|1}(\Sigma_{2,1})\rVert}=\frac{\lVert{\tilde\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y} - {\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert {\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} = \frac{\lVert({\tilde\Sigma_{2,1}} - {\Sigma_{2,1}})\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \overset{*^1}\leq \frac{\lVert {\tilde\Sigma_{2,1}} - {\Sigma_{2,1}}||\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} = \frac{\lVert{\Sigma_{2,1}}\rVert\lVert\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \frac{\lVert{\tilde\Sigma_{2,1}} - {\Sigma_{2,1}}\rVert}{\lVert{\Sigma_{2,1}}\rVert} = \kappa_1 \frac{\lVert{\tilde\Sigma_{2,1}} - {\Sigma_{2,1}}\rVert}{\lVert{\Sigma_{2,1}}\rVert}$
mit
$\kappa_1 = \frac{\lVert{\Sigma_{2,1}}\rVert\lVert\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}$
für Teilproblem (1)

$\frac{\lVert\mu_{2|1}(\tilde\Sigma_{1,1})-\mu_{2|1}(\Sigma_{1,1})\rVert}{\lVert\mu_{2|1}(\Sigma_{1,1})\rVert} = \frac{\lVert{\Sigma_{2,1}}\tilde\Sigma_{1,1}^{-1}\mathbf{y} - {\Sigma_{2,1}}\Sigma_{1,1}^{-1}{\mathbf{y}}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \overset{*^1}\leq \frac{\lVert{\Sigma_{2,1}}\lVert\rVert\tilde\Sigma_{1,1}^{-1}-\Sigma_{1,1}^{-1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} =\frac{\lVert\Sigma_{2,1}\rVert\lVert\tilde\Sigma_{1,1}^{-1}(\Sigma_{1,1}-\tilde\Sigma_{1,1})\Sigma_{1,1}^{-1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}\overset{*^1}\leq\frac{\lVert\Sigma_{2,1}\rVert\lVert\tilde\Sigma_{1,1}^{-1}\rVert\lVert\Sigma_{1,1}-\tilde\Sigma_{1,1}\rVert \lVert\Sigma_{1,1}^{-1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}\overset{*^2}=\frac{\lVert\Sigma_{2,1}\rVert\lVert\Sigma_{1,1}^{-1}\rVert^2\lVert\Sigma_{1,1}-\tilde\Sigma_{1,1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}=\frac{\lVert\Sigma_{1,1}^{-1}\rVert^{2}\lVert{\Sigma_{2,1}}\rVert\lVert\mathbf{y}\rVert\lVert\Sigma_{1,1}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \frac{\lVert\tilde\Sigma_{1,1} - \Sigma_{1,1}\rVert}{\lVert\Sigma_{1,1}\rVert} \leq \lVert\Sigma_{1,1}\rVert\lVert\Sigma_{1,1}^{-1}\rVert \frac{\lVert\Sigma_{1,1}^{-1}\rVert\lVert{\Sigma_{2,1}}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}\frac{\lVert\tilde\Sigma_{1,1} - \Sigma_{1,1}\rVert}{\lVert\Sigma_{1,1}\rVert} = \kappa(\Sigma_{1,1})\frac{\lVert\Sigma_{1,1}^{-1}\rVert\lVert{\Sigma_{2,1}}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}\frac{\lVert\tilde\Sigma_{1,1} - \Sigma_{1,1}\rVert}{\lVert\Sigma_{1,1}\rVert}$mit
$\kappa_2 = \lVert\Sigma_{1,1}\rVert\lVert\Sigma_{1,1}^{-1}\rVert \frac{\lVert\Sigma_{1,1}^{-1}\rVert\lVert{\Sigma_{2,1}}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}$
=
$\kappa(\Sigma_{1,1})\frac{\lVert\Sigma_{1,1}^{-1}\rVert\lVert{\Sigma_{2,1}}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}$
für Teilproblem (2), wobei
$\lVert\Sigma_{1,1}\rVert\lVert\Sigma_{1,1}^{-1}\rVert$ die
Konditionszahl für die Berechnung der Inversen von $\Sigma_{1,1}$ ist

$\frac{\lVert\mu_{2|1}(\tilde{y})-\mu_{2|1}(y)\rVert}{\lVert\mu_{2|1}(y)\rVert}=\frac{\lVert{\Sigma_{2,1}}\tilde\Sigma_{1,1}^{-1}\mathbf{y} - \Sigma_{2,1}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \leq \frac{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}(\tilde{\mathbf{y}} - \mathbf{y})\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \overset{*^1}\leq \frac{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\rVert \lVert\tilde{\mathbf{y}} - \mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} = \frac{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \frac{\lVert{\tilde{y}} - {y}\rVert}{\lVert{y}\rVert} = \kappa_3 \frac{\lVert{\tilde{y}} - {y}\rVert}{\lVert {y}\rVert}$
mit
$\kappa_3 = \frac{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}$
als Konditionszahl für Teilproblem (3)

$*^1$ Submultiplikativität

$*^2$ $\tilde\Sigma_{1,1}^{-1} \rightarrow \Sigma_{1,1}^{-1}$ (folgt aus
Stetigkeit der Matrixinvertierung; Beweis siehe Lösung zu Übung 2.1
...
$\mu_{2|1}(\tilde\Sigma_{2,1}\tilde\Sigma_{1,1}^{-1}\tilde{y})=\kappa_1 \frac{\lVert{\tilde\Sigma_{2,1}} - {\Sigma_{2,1}}\rVert}{\lVert{\Sigma_{2,1}}\rVert} + \kappa_2\frac{\lVert\tilde\Sigma_{1,1} - \Sigma_{1,1}\rVert}{\lVert\Sigma_{1,1}\rVert} + \kappa_3 \frac{\lVert{\tilde{y}} - {y}\rVert}{\lVert {y}\rVert} = \frac{\lVert{\Sigma_{2,1}}\rVert\lVert\Sigma_{1,1}^{-1}\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \frac{\lVert{\tilde\Sigma_{2,1}} - {\Sigma_{2,1}}\rVert}{\lVert{\Sigma_{2,1}}\rVert}  + \kappa(\Sigma_{1,1})\frac{\lVert\Sigma_{1,1}^{-1}\rVert\lVert{\Sigma_{2,1}}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert}\frac{\lVert\tilde\Sigma_{1,1} - \Sigma_{1,1}\rVert}{\lVert\Sigma_{1,1}\rVert}+\frac{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\rVert\lVert\mathbf{y}\rVert}{\lVert{\Sigma_{2,1}}\Sigma_{1,1}^{-1}\mathbf{y}\rVert} \frac{\lVert{\tilde{y}} - {y}\rVert}{\lVert{y}\rVert}$
...
```{r}
# alg_Inv
# berechnet mü2.1 mittels solve()
# Input: 
## t.Strich: Vektor der Länge m mit gesampleten Zeitpunkten
## t.data: Vektor der Länge n mit gesampleten Zeitpunkten aus dem Intervall, in dem beobachtete Daten vorliegen
## y.data: Vektor der Länge n mit tatsächlich beobachteten Daten
